class PropertiesController < ApplicationController
  ...
  private
    ...
    def property_params
      params.require(:property).permit(:address, :square_meters, :property_type_id, :renter_id, :rent_value, :number, :subunits_number, :owner_id, :bank_id, :bank_account_number, :comune_id)
    end
end
