...
class OutcomesControllerTest < ActionController::TestCase
  ...
  test "should create outcome" do
    assert_difference('Outcome.count') do
      post :create, outcome: { ammount: @outcome.ammount, date: @outcome.date, details: @outcome.details, property_id: @outcome.property_id, type: @outcome.type }
    end
  ...
  test "should update outcome" do
    patch :update, id: @outcome, outcome: { ammount: @outcome.ammount, date: @outcome.date, details: @outcome.details, property_id: @outcome.property_id, type: @outcome.type }
    assert_redirected_to outcome_path(assigns(:outcome))
  end
